import {
  ...
  export default function ManagerSidebar() {
    const menuItems = [
      ...
      { to: "/manager/products", icon: Package, label: "All Products" },
      { to: "/manager/add-product", icon: PlusCircle, label: "Add New" },
      { to: "/manager/stocks", icon: PackageSearch, label: "Stocks" },
      { to: "/manager/suppliers", icon: Truck, label: "Suppliers" },
      { to: "/manager/add-suppliers", icon: Truck, label: "Add New Supplier" },
