...
export default function SuppliersManager() {
  ...
  useEffect(() => {
    const fetchSupplier = async () => {
      ...
      let response = await axios.get(
        "http://localhost:1212/manager/suppliers",
        {
          headers: {
  ...
  const handleDeleteSupplier = async (selectedSupplier: Supplier) => {
    ...
    try {
      ...
      await axios.delete(
        `http://localhost:1212/manager/delete-supplier/${selectedSupplier._id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
              ...
              onSubmit={async (e) => {
                ...
                try {
                  ...
                  const response = await axios.patch(
                    `http://localhost:1212/manager/update-supplier/${selectedSupplier._id}`,
                    updatedProduct,
                    {
                      headers: {
                        Authorization: `Bearer ${token}`,
